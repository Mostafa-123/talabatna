...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('addOfficeBoy') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-primary" style="float: right;">Add New Office Boy</button>
            </div>
        </form>
    </div>
@endsection
