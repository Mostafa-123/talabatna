...
@section('content')
    ...
    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row" style="float: right;">
                                    <a style="padding: 1px 0px ; width: 30px" class="btn btn-info m-1" href="{{ route('editUserStatus', [$item->id]) }}">&ocir;</a>
                                    <a style="padding: 1px 0px ; width: 30px" class="btn btn-danger m-1"  href="{{ route('deleteUserStatus', [$item->id]) }}">&Cross;</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
        ...
        <div class="col-sm-6" style="border-left: 1px solid gainsboro; height: 100%">
            <p>Add new status</p>
            <form action="{{ route('addUserStatus') }}" method="POST">
                @csrf
