                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row" style="float: right;">
                                    <a style="padding: 1px 0px ; width: 30px" class="btn btn-info m-1" href="{{ route('edit_department', [$item->id]) }}">&ocir;</a>
                                    <a style="padding: 1px 0px ; width: 30px" class="btn btn-danger m-1"  href="{{ route('delete_Department', [$item->id]) }}">&Cross;</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
