...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('updateOfficeBoy', [$data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-primary" style="float: right;">Update Office Boy</button>
            </div>
        </form>
    </div>
@endsection
